...
def getData(dataset):
    if dataset == 'ONEIL':
        ...
        DDI_matrix_file = '../Data/ONEIL-COSMIC/DDI_matrix.csv'
    else:
        ...
        DDI_matrix_file = '../Data/ALMANAC-COSMIC/DDI_matrix.csv'
    ...
    DDI = pd.read_csv(DDI_matrix_file, sep=',',index_col=False, header=None)
    DDI = np.array(DDI)
    return cline_fea, drug_fea, drug_smiles_fea, gene_data, synergy, DDI